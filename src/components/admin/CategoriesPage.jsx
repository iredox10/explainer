    ...
    <div className="min-h-screen bg-gray-50 flex font-sans text-gray-900">
      ...
      <main className="lg:ml-64 flex-1 p-4 md:p-8 pt-24 lg:pt-8">
        <header className="flex flex-col md:flex-row justify-between items-start md:items-center gap-6 mb-8">
          <div>
            <h1 className="text-2xl font-black text-gray-900 uppercase tracking-tighter">Categories</h1>
            <p className="text-gray-500 text-sm mt-1 font-medium">Manage content topics and tags</p>
          </div>
          <button
            onClick={openAddModal}
            className="w-full md:w-auto bg-[#121212] hover:bg-[#008751] text-white px-6 py-3 rounded-xl text-xs font-black uppercase tracking-widest flex items-center justify-center gap-2 transition-all shadow-xl"
          >
