    ...
    <div className="min-h-screen bg-gray-50 flex font-sans text-gray-900">
      ...
      <aside className="w-64 bg-[#1a1a1a] text-white flex flex-col fixed h-full">
        <div className="h-16 flex items-center px-6 border-b border-gray-800">
          <span className="font-black text-xl tracking-tight">VOX<span className="text-[#008751]">.</span>CMS</span>
        </div>
        
        <nav className="flex-1 py-6 px-3 space-y-1">
          <a href="#" className="flex items-center gap-3 px-3 py-2 bg-[#008751] rounded-md text-sm font-bold">
            <Layout className="w-4 h-4" />
            Dashboard
          </a>
          <a href="#" className="flex items-center gap-3 px-3 py-2 text-gray-400 hover:text-white hover:bg-gray-800 rounded-md text-sm font-medium transition-colors">
        ...
        <div className="p-4 border-t border-gray-800">
          <a href="#" className="flex items-center gap-3 px-3 py-2 text-gray-400 hover:text-white rounded-md text-sm font-medium">
